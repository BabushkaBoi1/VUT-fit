Feature: VALU3S app method and tool edit
  ...
  Background: user is logged in as "Administrator"

      Scenario: user wants to create tool
        Given user is on page Add tool
         And user filled all required fields
      ...
      Scenario: user wants to edit method
        ...
        When user click on button save
        Then user is transfered to modified method page
         And page shows Info "Changes saved"
